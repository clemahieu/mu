...
namespace lambda_p_repl
{
	...
	public:
		...
		void core (lambda_p::core::statement * statement, lambda_p::binder::list & nodes, lambda_p::errors::error_list & problems, boost::shared_ptr <lambda_p::lexer::character_stream> stream);
