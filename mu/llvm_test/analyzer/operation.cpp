...
void mu::llvm_test::analyzer::operation::run_1 ()
{
    ...
    auto ctx (mu::script::context (builder.errors, a2, r2, stack, context_stack));
	analyzer (ctx);
	assert (builder.errors->errors.empty ());
	...
	a3.push_back (module);
    auto ctx2 (mu::script::context (builder.errors, a3, r3, stack, context_stack));
	print (ctx2);
	mu::llvm_::module::verify verify;
    auto ctx3 (mu::script::context (builder.errors, a3, r3, stack, context_stack));
	verify (ctx3);
	assert (builder.errors->errors.empty ());
	assert (r2.size () == 1);
