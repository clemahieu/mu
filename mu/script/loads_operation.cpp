...
{
	bool complete (mu::core::check <mu::script::file::node> (context_a));
	if (complete)
	{
...
{
	bool complete (mu::core::check <mu::script::parser_scope::node, mu::script::file::node> (context_a));
	if (complete)
	{
        auto extensions (static_cast <mu::script::parser_scope::node *> (context_a.parameters (0)));
		auto file (static_cast <mu::script::file::node *> (context_a.parameters (1)));
...
mu::script::cluster::node * mu::script::loads::operation::core (mu::script::context & context_a, mu::script::parser_scope::node * scope_a, mu::script::file::node * file)
{
    mu::script::cluster::node * result (nullptr);
    auto input (new (GC) mu::io::lexer::istream_input (file->stream));
