...
namespace mu
{
	...
	namespace script
	{
		...
		namespace cluster
		{
			...
			public:
				node ();
				node (std::vector <boost::shared_ptr <mu::script::routine>> routines_a, std::map <boost::shared_ptr <mu::core::routine>, boost::shared_ptr <mu::core::node>> mapping_a);
				node (std::map <std::wstring, boost::shared_ptr <mu::core::routine>> names_a, std::vector <boost::shared_ptr <mu::script::routine>> routines_a, std::map <boost::shared_ptr <mu::core::routine>, boost::shared_ptr <mu::core::node>> mapping_a);
				...
				std::vector <boost::shared_ptr <mu::script::routine>> routines;
			};
		}
	}
}
