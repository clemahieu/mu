...
{
    bool error (false);
    error = builtins.insert  (U"~", ast.value (new (GC) mu::llvmc::skeleton::identity));
    assert (!error);
    ...
    assert (!error);
    error = builtins.insert (U"add", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::add)));
    assert (!error);
    error = builtins.insert (U"alloca", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::alloca)));
    assert (!error);
    error = builtins.insert (U"and", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::and_i)));
    assert (!error);
    error = builtins.insert (U"ashr", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::ashr)));
    assert (!error);
    error = builtins.insert (U"atomicrmw", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::atomicrmw)));
    assert (!error);
    error = builtins.insert (U"bitcast", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::bitcast)));
    assert (!error);
    error = builtins.insert (U"call", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::call)));
    assert (!error);
    error = builtins.insert (U"cmpxchg", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::cmpxchg)));
    assert (!error);
    error = builtins.insert (U"extractelement", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::extractelement)));
    assert (!error);
    error = builtins.insert (U"extractvalue", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::extractvalue)));
    assert (!error);
    error = builtins.insert (U"fadd", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fadd)));
    assert (!error);
    error = builtins.insert (U"fcmp", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fcmp)));
    assert (!error);
    error = builtins.insert (U"fdiv", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fdiv)));
    assert (!error);
    error = builtins.insert (U"fence", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fence)));
    assert (!error);
    error = builtins.insert (U"fmul", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fmul)));
    assert (!error);
    error = builtins.insert (U"fpext", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fpext)));
    assert (!error);
    error = builtins.insert (U"fptoi", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fptoi)));
    assert (!error);
    error = builtins.insert (U"fptosi", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fptosi)));
    assert (!error);
    error = builtins.insert (U"fptoui", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fptoui)));
    assert (!error);
    error = builtins.insert (U"fptrunc", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fptrunc)));
    assert (!error);
    error = builtins.insert (U"frem", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::frem)));
    assert (!error);
    error = builtins.insert (U"fsub", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fsub)));
    assert (!error);
    error = builtins.insert (U"getelementptr", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::getelementptr)));
    assert (!error);
    error = builtins.insert (U"icmp", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::icmp)));
    assert (!error);
    error = builtins.insert (U"ieq", ast.value (new (GC) mu::llvmc::skeleton::predicate (mu::llvmc::predicates::icmp_eq)));
    assert (!error);
    error = builtins.insert (U"ine", ast.value (new (GC) mu::llvmc::skeleton::predicate (mu::llvmc::predicates::icmp_ne)));
    assert (!error);
    error = builtins.insert (U"iugt", ast.value (new (GC) mu::llvmc::skeleton::predicate (mu::llvmc::predicates::icmp_ugt)));
    assert (!error);
    error = builtins.insert (U"iuge", ast.value (new (GC) mu::llvmc::skeleton::predicate (mu::llvmc::predicates::icmp_uge)));
    assert (!error);
    error = builtins.insert (U"iult", ast.value (new (GC) mu::llvmc::skeleton::predicate (mu::llvmc::predicates::icmp_ult)));
    assert (!error);
    error = builtins.insert (U"iule", ast.value (new (GC) mu::llvmc::skeleton::predicate (mu::llvmc::predicates::icmp_ule)));
    assert (!error);
    error = builtins.insert (U"isgt", ast.value (new (GC) mu::llvmc::skeleton::predicate (mu::llvmc::predicates::icmp_sgt)));
    assert (!error);
    error = builtins.insert (U"isge", ast.value (new (GC) mu::llvmc::skeleton::predicate (mu::llvmc::predicates::icmp_sge)));
    assert (!error);
    error = builtins.insert (U"islt", ast.value (new (GC) mu::llvmc::skeleton::predicate (mu::llvmc::predicates::icmp_slt)));
    assert (!error);
    error = builtins.insert (U"isle", ast.value (new (GC) mu::llvmc::skeleton::predicate (mu::llvmc::predicates::icmp_sle)));
    assert (!error);
    error = builtins.insert (U"if", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::if_i)));
    assert (!error);
    error = builtins.insert (U"insertelement", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::insertelement)));
    assert (!error);
    error = builtins.insert (U"insertvalue", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::insertvalue)));
    assert (!error);
    error = builtins.insert (U"load", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::load)));
    assert (!error);
    error = builtins.insert (U"lshr", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::lshr)));
    assert (!error);
    error = builtins.insert (U"mul", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::mul)));
    assert (!error);
    error = builtins.insert (U"or", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::or_i)));
    assert (!error);
    error = builtins.insert (U"ptrfromint", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::inttoptr)));
    assert (!error);
    error = builtins.insert (U"ptrtoint", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::ptrtoint)));
    assert (!error);
    error = builtins.insert (U"sdiv", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::sdiv)));
    assert (!error);
    error = builtins.insert (U"select", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::select)));
    assert (!error);
    error = builtins.insert (U"sext", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::sext)));
    assert (!error);
    error = builtins.insert (U"shl", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::shl)));
    assert (!error);
    error = builtins.insert (U"shufflevector", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::shufflevector)));
    assert (!error);
    error = builtins.insert (U"sitofp", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::sitofp)));
    assert (!error);
    error = builtins.insert (U"srem", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::srem)));
    assert (!error);
    error = builtins.insert (U"store", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::store)));
    assert (!error);
    error = builtins.insert (U"sub", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::sub)));
    assert (!error);
    error = builtins.insert (U"switch", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::switch_i)));
    assert (!error);
    error = builtins.insert (U"trunc", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::trunc)));
    assert (!error);
    error = builtins.insert (U"typeof", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::typeof_i)));
    assert (!error);
    error = builtins.insert (U"udiv", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::udiv)));
    assert (!error);
    error = builtins.insert (U"uitofp", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::uitofp)));
    assert (!error);
    error = builtins.insert (U"urem", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::urem)));
    assert (!error);
    error = builtins.insert (U"unit", ast.value (new (GC) mu::llvmc::skeleton::unit_type));
    assert (!error);
    error = builtins.insert (U"xor", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::xor_i)));
    assert (!error);
    error = builtins.insert (U"zext", ast.value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::zext)));
    assert (!error);
}
...
void mu::llvmc::function::parse_result_set ()
{
    ...
    while (result.error == nullptr && !done && !predicates)
    {
		...
		{
            auto result_l (parser.ast.result ());
            ...
            while (!done)
            {
                ...
                else if (next.token != nullptr)
                {
                    switch (next.token->id ())
                    {
                        ...
                        {
							auto identifier (mu::cast <mu::io::identifier> (next.token));
                            auto parameter (parser.ast.loop_parameter (identifier->string));
...
mu::llvmc::node_result mu::llvmc::string_hook::parse (mu::core::region const & region_a, mu::string const & data_a, mu::llvmc::parser & parser_a)
{
    ...
    (mu::io::identifier * identifier_a)
    {
		...
		result.node = parser_a.ast.value (value);
		return nullptr;
