...
{
    bool error (false);
    error = globals.insert  (U"~", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::identity));
    assert (!error);
    ...
    assert (!error);
    error = globals.insert  (U"false", empty_region, new (GC) mu::llvmc::ast::constant_int (U"1", new (GC) mu::llvmc::ast::number (U"0")));
    assert (!error);
    error = globals.insert  (U"true", empty_region, new (GC) mu::llvmc::ast::constant_int (U"1", new (GC) mu::llvmc::ast::number (U"1")));
    assert (!error);
    error = globals.insert (U"unit_v", empty_region, new (GC) mu::llvmc::ast::unit);
    assert (!error);
    error = globals.insert (U"join", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::join));
    assert (!error);
    error = globals.insert (U"add", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::add)));
    assert (!error);
    error = globals.insert (U"alloca", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::alloca)));
    assert (!error);
    error = globals.insert (U"and", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::and_i)));
    assert (!error);
    error = globals.insert (U"ashr", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::ashr)));
    assert (!error);
    error = globals.insert (U"atomicrmw", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::atomicrmw)));
    assert (!error);
    error = globals.insert (U"bitcast", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::bitcast)));
    assert (!error);
    error = globals.insert (U"call", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::call)));
    assert (!error);
    error = globals.insert (U"cmpxchg", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::cmpxchg)));
    assert (!error);
    error = globals.insert (U"eq", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::predicate (mu::llvmc::predicates::icmp_eq)));
    assert (!error);
    error = globals.insert (U"extractelement", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::extractelement)));
    assert (!error);
    error = globals.insert (U"extractvalue", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::extractvalue)));
    assert (!error);
    error = globals.insert (U"fadd", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fadd)));
    assert (!error);
    error = globals.insert (U"fcmp", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fcmp)));
    assert (!error);
    error = globals.insert (U"fdiv", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fdiv)));
    assert (!error);
    error = globals.insert (U"fence", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fence)));
    assert (!error);
    error = globals.insert (U"fmul", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fmul)));
    assert (!error);
    error = globals.insert (U"fpext", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fpext)));
    assert (!error);
    error = globals.insert (U"fptoi", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fptoi)));
    assert (!error);
    error = globals.insert (U"fptosi", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fptosi)));
    assert (!error);
    error = globals.insert (U"fptoui", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fptoui)));
    assert (!error);
    error = globals.insert (U"fptrunc", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fptrunc)));
    assert (!error);
    error = globals.insert (U"frem", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::frem)));
    assert (!error);
    error = globals.insert (U"fsub", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::fsub)));
    assert (!error);
    error = globals.insert (U"getelementptr", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::getelementptr)));
    assert (!error);
    error = globals.insert (U"icmp", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::icmp)));
    assert (!error);
    error = globals.insert (U"if", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::if_i)));
    assert (!error);
    error = globals.insert (U"insertelement", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::insertelement)));
    assert (!error);
    error = globals.insert (U"insertvalue", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::insertvalue)));
    assert (!error);
    error = globals.insert (U"load", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::load)));
    assert (!error);
    error = globals.insert (U"lshr", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::lshr)));
    assert (!error);
    error = globals.insert (U"mul", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::mul)));
    assert (!error);
    error = globals.insert (U"or", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::or_i)));
    assert (!error);
    error = globals.insert (U"ptrfromint", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::inttoptr)));
    assert (!error);
    error = globals.insert (U"ptrtoint", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::ptrtoint)));
    assert (!error);
    error = globals.insert (U"sdiv", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::sdiv)));
    assert (!error);
    error = globals.insert (U"select", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::select)));
    assert (!error);
    error = globals.insert (U"sext", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::sext)));
    assert (!error);
    error = globals.insert (U"shl", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::shl)));
    assert (!error);
    error = globals.insert (U"shufflevector", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::shufflevector)));
    assert (!error);
    error = globals.insert (U"sitofp", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::sitofp)));
    assert (!error);
    error = globals.insert (U"srem", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::srem)));
    assert (!error);
    error = globals.insert (U"store", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::store)));
    assert (!error);
    error = globals.insert (U"sub", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::sub)));
    assert (!error);
    error = globals.insert (U"switch", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::switch_i)));
    assert (!error);
    error = globals.insert (U"trunc", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::trunc)));
    assert (!error);
    error = globals.insert (U"udiv", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::udiv)));
    assert (!error);
    error = globals.insert (U"uitofp", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::uitofp)));
    assert (!error);
    error = globals.insert (U"urem", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::urem)));
    assert (!error);
    error = globals.insert (U"void", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::void_t));
    assert (!error);
    error = globals.insert (U"xor", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::xor_i)));
    assert (!error);
    error = globals.insert (U"zext", empty_region, new (GC) mu::llvmc::ast::value (new (GC) mu::llvmc::skeleton::marker (mu::llvmc::instruction_type::zext)));
    assert (!error);
}
