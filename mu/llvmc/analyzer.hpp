...
namespace mu
{
    ...
    namespace llvmc
    {
        ...
        public:
            ...
            mu::llvmc::value_cardinality process_node (mu::llvmc::ast::node * node_a);
            void process_element (mu::llvmc::ast::element * element_a);
            mu::llvmc::value_cardinality process_value_call (mu::vector <mu::llvmc::skeleton::node *> & arguments_a, mu::llvmc::skeleton::branch * branch_a, mu::llvmc::ast::node * expression_a);
            mu::llvmc::value_cardinality process_marker (mu::vector <mu::llvmc::skeleton::node *> & arguments_a, mu::llvmc::skeleton::branch * branch_a, mu::llvmc::ast::node * expression_a);
            ...
            mu::llvmc::value_cardinality process_definite_expression (mu::llvmc::ast::definite_expression * node_a);
