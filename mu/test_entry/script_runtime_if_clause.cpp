...
TEST (script_test, if_clause1)
{
    ...
    if_l->predicate = new (GC) mu::script::runtime::definite_expression;
    ...
    if_l->true_branch = new (GC) mu::script::runtime::definite_expression;
    ...
    if_l->false_branch = new (GC) mu::script::runtime::definite_expression;
