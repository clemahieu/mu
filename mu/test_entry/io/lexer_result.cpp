...
void mu::io_test::lexer_result::operator () (mu::io::tokens::token * token_a, mu::io::context context_a)
{
	results.push_back (std::pair <mu::io::tokens::token *, mu::io::context> (token_a, context_a));
}
