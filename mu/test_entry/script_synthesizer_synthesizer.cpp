...
TEST (script_test, synthesizer_operation2)
{
    ...
    auto expression1 (dynamic_cast <mu::script::runtime::definite_expression *> (routine2->expressions [0]));
...
TEST (script_test, synthesizer_operation3)
{
    ...
    auto expression2 (dynamic_cast <mu::script::runtime::definite_expression *> (routine2->expressions [0]));
    auto expression3 (dynamic_cast <mu::script::runtime::definite_expression *> (routine2->expressions [1]));
    ...
    ASSERT_TRUE (expression3 != nullptr);
...
TEST (script_test, synthesizer_operation6)
{
    ...
    auto expression1 (dynamic_cast <mu::script::runtime::definite_expression *> (routine3->expressions [0]));
    ASSERT_TRUE (expression1 != nullptr);
    ASSERT_TRUE (expression1->dependencies.size () == 1);
    ...
    auto expression2 (dynamic_cast <mu::script::runtime::definite_expression *> (routine4->expressions [0]));
    ASSERT_TRUE (expression2 != nullptr);
    ASSERT_TRUE (expression2->dependencies.size () == 1);
