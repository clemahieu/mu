...
TEST (llvmc_generator, generate_if)
{
    ...
    mu::llvmc::skeleton::constant_integer integer1 (mu::empty_region, 1, 0);
    ...
    mu::llvmc::skeleton::constant_integer integer2 (mu::empty_region, 1, 1);
...
TEST (llvmc_generator, generate_if_value)
{
    ...
    mu::llvmc::skeleton::constant_integer integer3 (mu::empty_region, 32, 4);
    ...
    mu::llvmc::skeleton::result result2 (&module.the_unit_type, &named2);
    function1.results.push_back (&result2);
    mu::llvmc::skeleton::constant_integer integer4 (mu::empty_region, 32, 5);
...
TEST (llvmc_generator, generate_call_3)
{
    ...
    mu::llvmc::skeleton::result result1 (&module.the_unit_type, &element1);
    function1.results.push_back (&result1);
    mu::llvmc::skeleton::constant_integer constant1 (mu::empty_region, 32, 1);
    ...
    mu::llvmc::skeleton::result result2 (&module.the_unit_type, &element2);
    function1.results.push_back (&result2);
    mu::llvmc::skeleton::constant_integer constant2 (mu::empty_region, 32, 2);
...
TEST (llvmc_generator, generate_loop1)
{
	...
	mu::llvmc::skeleton::predicate predicate1 (mu::llvmc::predicates::icmp_eq);
	mu::llvmc::skeleton::constant_integer constant_integer1 (mu::empty_region, 1, 0);
	...
	mu::llvmc::skeleton::constant_integer constant_integer2 (mu::empty_region, 1, 0);
	...
	mu::llvmc::skeleton::constant_integer constant_integer3 (mu::empty_region, 1, 1);
...
TEST (llvmc_generator, generate_loop_count)
{
	...
	loop1.loop_entry_branch = &loop_entry_branch;
	loop1.arguments.push_back (&parameter1);
	mu::llvmc::skeleton::constant_integer constant_integer1 (mu::empty_region, 32, 0);
	...
	mu::llvmc::skeleton::marker marker3 (mu::llvmc::instruction_type::add);
	arguments3.push_back (&marker3);
	mu::llvmc::skeleton::constant_integer constant_integer4 (mu::empty_region, 32, 1);
...
TEST (llvmc_generator, generate_getelementptr)
{
    ...
    arguments1.push_back (&marker1);
    arguments1.push_back (&parameter1);
	mu::llvmc::skeleton::constant_integer constant1 (mu::empty_region, 8, 0);
...
TEST (llvmc_generator, generate_asm2)
{
	...
	mu::vector <mu::llvmc::skeleton::node *> arguments;
	mu::llvmc::skeleton::constant_integer constant1 (mu::empty_region, 32, 0xffeeddcc);
	arguments.push_back (&asm1);
...
TEST (llvmc_generator, generate_array)
{
    ...
    mu::llvmc::skeleton::constant_integer constant2 (mu::empty_region, 8, 0xcd);
...
TEST (llvmc_generator, generate_if_join_value_predicate)
{
    ...
    mu::llvmc::skeleton::named named2 (mu::empty_region, &element2, U"element2");
    mu::llvmc::skeleton::constant_integer constant1 (mu::empty_region, 32, 42);
    mu::llvmc::skeleton::constant_integer constant2 (mu::empty_region, 32, 13);
    mu::llvmc::skeleton::join_value join1;
    auto & branch3 (join1.add_branch ());
...
TEST (llvmc_generator, generate_insertvalue)
{
	...
	arguments.push_back (&parameter1);
	mu::llvmc::skeleton::constant_integer constant1 (mu::empty_region, 32, 0);
	arguments.push_back (&constant1);
