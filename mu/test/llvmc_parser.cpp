...
TEST (llvmc_parser, simple)
{
    ...
    auto function2 (dynamic_cast <mu::llvmc::ast::function_declaration *> (module2->functions [0]));
    ASSERT_NE (nullptr, function2);
    auto function1 (dynamic_cast <mu::llvmc::ast::function *> (function2->function));
...
TEST (llvmc_parser, recursive)
{
    ...
    auto function3 (dynamic_cast <mu::llvmc::ast::function_declaration *> (module2->functions [0]));
    ASSERT_NE (nullptr, function3);
    auto function1 (dynamic_cast <mu::llvmc::ast::function *> (function3->function));
    ASSERT_NE (nullptr, function1);
    EXPECT_EQ (0, function1->parameters.size ());
    EXPECT_EQ (0, function1->results.size ());
    ...
    auto function4 (dynamic_cast <mu::llvmc::ast::function_declaration *> (module2->functions [1]));
    ASSERT_NE (nullptr, function4);
    auto function2 (dynamic_cast <mu::llvmc::ast::function *> (function4->function));
    ASSERT_NE (nullptr, function2);
...
{
    test_parser parser ("function test1 [] [[string thing]] []");
    auto module1 (parser.parser.parse ());
    EXPECT_EQ (nullptr, module1.error);
    ASSERT_NE (nullptr, module1.node);
    auto module2 (dynamic_cast <mu::llvmc::ast::module *> (module1.node));
...
{
    test_parser parser ("function test1 [] [[string string]] []");
    auto module1 (parser.parser.parse ());
    EXPECT_EQ (nullptr, module1.error);
    ASSERT_NE (nullptr, module1.node);
    auto module2 (dynamic_cast <mu::llvmc::ast::module *> (module1.node));
...
{
    test_parser parser ("function test1 [] [[ascii string]] []");
    auto module1 (parser.parser.parse ());
    EXPECT_EQ (nullptr, module1.error);
    ASSERT_NE (nullptr, module1.node);
    auto module2 (dynamic_cast <mu::llvmc::ast::module *> (module1.node));
