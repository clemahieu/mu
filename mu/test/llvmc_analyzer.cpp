...
TEST (llvmc_analyzer, empty_function)
{
    ...
    auto function1 (dynamic_cast <mu::llvmc::skeleton::function *> (result.module->functions [U"0"]));
...
TEST (llvmc_analyzer, error_indistinct_result_branches2)
{
    ...
    mu::llvmc::ast::value value2 (&mu::llvmc::skeleton::the_unit_type);
    mu::llvmc::ast::result result1 (&value2);
    result1.value = &element1;
    function.results.push_back (&result1);
    function.branch_ends.push_back (function.results.size ());
    function.predicate_offsets.push_back (function.results.size ());
    mu::llvmc::ast::result result2 (&value2);
    result2.value = &parameter1;
    function.results.push_back (&result2);
    function.branch_ends.push_back (function.results.size ());
    function.predicate_offsets.push_back (function.results.size ());
...
TEST (llvmc_analyzer, branches)
{
    ...
    expression2.arguments.push_back (&marker1);
    ...
    expression3.arguments.push_back (&marker1);
    ...
    function.branch_ends.push_back (function.results.size ());
    function.predicate_offsets.push_back (function.results.size ());
    mu::llvmc::ast::result result2 (&type4);
...
TEST (llvmc_analyzer, empty_call)
{
    ...
    module1.globals [U"1"] = &function2;
    auto result (analyzer.analyze (&module1));
    ASSERT_EQ (nullptr, result.error);
    ASSERT_NE (nullptr, result.module);
    ASSERT_EQ (2, result.module->functions.size ());
    auto function3 (dynamic_cast <mu::llvmc::skeleton::function *> (result.module->functions [U"0"]));
    ...
    auto function4 (dynamic_cast <mu::llvmc::skeleton::function *> (result.module->functions [U"1"]));
...
TEST (llvmc_analyzer, empty_call_predicate)
{
    ...
    auto function4 (dynamic_cast <mu::llvmc::skeleton::function *> (result.module->functions [U"0"]));
    ASSERT_EQ (0, function4->parameters.size ());
    ASSERT_EQ (1, function4->results.size ());
    ASSERT_EQ (1, function4->branch_ends.size ());
    ASSERT_EQ (1, function4->branch_ends [0]);
    ASSERT_EQ (1, function4->predicate_offsets.size ());
    ASSERT_EQ (0, function4->predicate_offsets [0]);
    auto function5 (dynamic_cast <mu::llvmc::skeleton::function *> (result.module->functions [U"1"]));
    ...
    auto function6 (dynamic_cast <mu::llvmc::skeleton::function *> (result.module->functions [U"2"]));
...
TEST (llvmc_analyzer, set_expression_empty)
{
    ...
    ASSERT_NE (nullptr, result.module);
    ASSERT_EQ (1, result.module->functions.size ());
    auto function2 (dynamic_cast <mu::llvmc::skeleton::function *> (result.module->functions [U"0"]));
...
TEST (llvmc_analyzer, instruction_alloca)
{
    ...
    mu::llvmc::ast::result result1 (&type3);
    result1.value = &expression1;
    function1.results.push_back (&result1);
    function1.branch_ends.push_back (function1.results.size ());
    function1.predicate_offsets.push_back (function1.results.size ());
...
TEST (llvmc_analyzer, instruction_switch)
{
    ...
    expression1.arguments.push_back (&constant2);
    expression1.set_predicate_position ();
    mu::llvmc::ast::element element1 (&expression1, 0, 2, U"element1", empty_region);
    mu::llvmc::ast::element element2 (&expression1, 1, 2, U"element2", empty_region);
    mu::llvmc::ast::value value2 (&mu::llvmc::skeleton::the_unit_type);
