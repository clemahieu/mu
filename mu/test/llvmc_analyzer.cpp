...
TEST (llvmc_analyzer, one_result_parameter)
{
    ...
    ASSERT_EQ (1, function1->results [0].values.size ());
    auto result2 (dynamic_cast <mu::llvmc::skeleton::result *> (function1->results [0].values [0]));
...
TEST (llvmc_analyzer, two_result_parameter)
{
    ...
    auto parameter2 (function1->parameters [0]);
    ASSERT_EQ (1, function1->results.size ());
    ASSERT_EQ (2, function1->results [0].values.size ());
    auto result3 (dynamic_cast <mu::llvmc::skeleton::result *> (function1->results [0].values [0]));
    ASSERT_NE (nullptr, result3);
    ...
    auto result5 (dynamic_cast <mu::llvmc::skeleton::result *> (function1->results [0].values [1]));
...
TEST (llvmc_analyzer, if_instruction)
{
    ...
    ASSERT_EQ (1, function1->results [0].values.size ());
    ASSERT_EQ (1, function1->results [1].values.size ());
    auto result3 (dynamic_cast <mu::llvmc::skeleton::result *> (function1->results [0].values [0]));
    ASSERT_NE (nullptr, result3);
    ...
    auto result4 (dynamic_cast <mu::llvmc::skeleton::result *> (function1->results [1].values [0]));
    ASSERT_NE (nullptr, result4);
...
TEST (llvmc_analyzer, empty_call)
{
    ...
    auto sequence3 (dynamic_cast <mu::llvmc::skeleton::sequence *> (function4->results [0].values [0]));
    ASSERT_NE (nullptr, sequence3);
    ASSERT_EQ (1, sequence3->values.size ());
    auto element1 (dynamic_cast <mu::llvmc::skeleton::call_element *> (sequence3->values [0]));
...
TEST (llvmc_analyzer, call_no_return)
{
    ...
    ASSERT_EQ (1, sequence2->values.size ());
    auto element1 (dynamic_cast <mu::llvmc::skeleton::call_element *> (sequence2->values [0]));
    ASSERT_NE (nullptr, element1);
    ASSERT_EQ (1, element1->source->elements.size ());
    ASSERT_EQ (element1, element1->source->elements [0]);
}
...
TEST (llvmc_analyzer, empty_call_predicate)
{
    ...
    mu::llvmc::ast::sequence sequence2 (&unit1);
    function3.results = {{&sequence2}};
...
TEST (llvmc_analyzer, constant_int)
{
    ...
    ASSERT_EQ (1, function2->results.size ());
    ASSERT_EQ (1, function2->results [0].values.size ());
    auto sequence2 (dynamic_cast <mu::llvmc::skeleton::sequence *> (function2->results [0].values [0]));
    ASSERT_NE (nullptr, sequence2);
    ASSERT_EQ (1, sequence2->values.size ());
    auto predicate1 (dynamic_cast <mu::llvmc::skeleton::constant_integer *> (sequence2->values [0]));
...
TEST (llvmc_analyzer, loop_empty)
{
    ...
    ASSERT_NE (nullptr, sequence2);
    ASSERT_EQ (1, sequence2->values.size ());
	auto element1 (dynamic_cast <mu::llvmc::skeleton::loop_element *> (sequence2->values [0]));
	ASSERT_NE (nullptr, element1);
...
TEST (llvmc_analyzer, asm1)
{
    ...
    ASSERT_NE (nullptr, sequence2);
    ASSERT_EQ (1, sequence2->values.size ());
    auto asm2 (dynamic_cast <mu::llvmc::skeleton::inline_asm *> (sequence2->values [0]));
...
TEST (llvmc_analyzer, template_shared)
{
	...
	ASSERT_NE (nullptr, function2);
	ASSERT_EQ (1, function2->results.size ());
	auto result3 (dynamic_cast <mu::llvmc::skeleton::result *> (function2->results [0].values [0]));
	ASSERT_NE (nullptr, result3);
...
TEST (llvmc_analyzer, namespace_c_module)
{
    ...
    ASSERT_EQ (1, function3->results.size ());
    auto sequence3 (dynamic_cast <mu::llvmc::skeleton::sequence *> (function3->results [0].values [0]));
    ASSERT_NE (nullptr, sequence3);
    ASSERT_EQ (1, sequence3->values.size ());
    auto element3 (dynamic_cast <mu::llvmc::skeleton::call_element *> (sequence3->values [0]));
    ASSERT_NE (nullptr, element3);
    ...
    ASSERT_EQ (1, function4->results.size ());
    auto sequence4 (dynamic_cast <mu::llvmc::skeleton::sequence *> (function4->results [0].values [0]));
    ASSERT_NE (nullptr, sequence4);
    ASSERT_EQ (1, sequence4->values.size ());
	auto unit2 (dynamic_cast <mu::llvmc::skeleton::unit_value *> (sequence4->values [0]));
