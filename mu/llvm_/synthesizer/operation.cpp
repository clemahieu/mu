...
void mu::llvm_::synthesizer::operation::operator () (boost::shared_ptr <mu::core::errors::error_target> errors_a, mu::core::segment <boost::shared_ptr <mu::core::node>> parameters, std::vector <boost::shared_ptr <mu::core::node>> & results_a)
{
...
size_t mu::llvm_::synthesizer::operation::count ()
{
	return 2;
}