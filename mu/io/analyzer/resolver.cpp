...
mu::io::analyzer::resolver::resolver (boost::shared_ptr <mu::core::expression> unresolved_a, mu::io::debugging::expression * unresolved_info_a, size_t position_a)
...
void mu::io::analyzer::resolver::operator () (boost::shared_ptr <mu::core::node> node_a, mu::io::debugging::node * node_info_a)
{
