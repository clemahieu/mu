...
void lambda_p_llvm::wstring_binder::bind (lambda_p::core::statement * statement, lambda_p::binder::list & nodes, lambda_p::errors::error_list & problems)
{
	...
	if (problems.errors.empty ())
	{
		...
		auto data (boost::dynamic_pointer_cast <lambda_p_kernel::nodes::data> (nodes [statement->association->references [1]]));
...
void lambda_p_llvm::wstring_binder::core (boost::shared_ptr <lambda_p_llvm::module> module, boost::shared_ptr <lambda_p_kernel::nodes::data> data, boost::shared_ptr <lambda_p_llvm::type> type, boost::shared_ptr <lambda_p_llvm::value> & value)
{
