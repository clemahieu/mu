...
void lambda_p_llvm::instructions::bitcast::operator () (boost::shared_ptr <lambda_p::errors::error_target> errors_a, lambda_p::segment <boost::shared_ptr <lambda_p::node>> parameters_a, std::vector <boost::shared_ptr <lambda_p::node>> & results_a)
{
...
size_t lambda_p_llvm::instructions::bitcast::count ()
{
	return 2;
}