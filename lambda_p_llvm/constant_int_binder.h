...
namespace lambda_p_llvm
{
	...
	private:
		void parse_number (unsigned long base, unsigned long bits, ::std::wstring & number_wstring, size_t declaration_node, ::std::map < size_t, ::boost::shared_ptr < ::lambda_p::binder::node_instance> > & instances, ::std::vector < ::boost::shared_ptr < ::lambda_p::errors::error> > & problems);
