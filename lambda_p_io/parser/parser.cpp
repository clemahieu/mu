...
lambda_p_io::parser::parser::parser (boost::shared_ptr <mu::core::errors::error_target> errors_a, boost::function <void (boost::shared_ptr <lambda_p_io::ast::node>)> target_a)
	: target (target_a),
	errors (errors_a)
{
	reset ();
...
void lambda_p_io::parser::parser::operator () (lambda_p_io::tokens::token * token, mu::core::context context_a)
{
	context = context_a;
