...
namespace lambda_p_kernel
{
	...
	public:
		...
		void core (lambda_p_kernel::routine & routine, lambda_p::binder::node_list & nodes_l, lambda_p::errors::error_list & problems, lambda_p::binder::node_list & declarations);
