...
void lambda_p_kernel::compute::bind (lambda_p::core::statement * statement, lambda_p::binder::node_list & nodes, lambda_p::errors::error_list & problems)
{
	...
	if (problems.errors.empty ())
	{
		...
		if (problems.errors.empty ())
		{
			...
			boost::shared_ptr <lambda_p::binder::node_list> declarations (new lambda_p::binder::node_list);
