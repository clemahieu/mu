...
void lambda_p::core::gather::operator () (std::vector <boost::shared_ptr <lambda_p::core::node>> & arguments_a, size_t sequence)
{
	...
	if (remaining == 0)
	{
		std::vector <boost::shared_ptr <lambda_p::core::node>> all_arguments;
