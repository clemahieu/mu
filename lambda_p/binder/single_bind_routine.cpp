...
lambda_p::binder::single_bind_routine::single_bind_routine (::boost::shared_ptr < ::lambda_p::binder::routine> inner_routine_a, ::boost::shared_ptr < ::lambda_p::binder::routine_instances> inner_instances_a)
	: binder_m (new ::lambda_p::binder::routine_binder),
...
void lambda_p::binder::single_bind_routine::operator () (::std::vector < ::boost::shared_ptr < ::lambda_p::errors::error> > & problems)
{
