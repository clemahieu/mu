...
lambda_p::binder::data_to_string_binder::data_to_string_binder(void)
{
}
...
void lambda_p::binder::data_to_string_binder::bind (::lambda_p::core::statement * statement, ::std::map < ::lambda_p::core::node *, ::boost::shared_ptr < ::lambda_p::binder::node_instance> > & instances, ::std::wstringstream & problems)
{
...
void lambda_p::binder::data_to_string_binder::operator () ()
{
}