...
namespace lambda_p
{
	...
	namespace binder
	{
		...
		{
		public:
			single_bind_routine (::boost::shared_ptr < ::lambda_p::binder::routine> routine_a, ::boost::shared_ptr < ::lambda_p::binder::routine_instances> instances_a);
			...
			::boost::shared_ptr < ::lambda_p::binder::routine_binder> binder_m;
