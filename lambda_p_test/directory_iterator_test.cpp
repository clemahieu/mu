...
void lambda_p_test::directory_iterator_test::run ()
{
	run_1 ();
	run_2 ();
	run_3 ();
...
void lambda_p_test::directory_iterator_test::run_1 ()
{
	auto path (boost::filesystem::initial_path () /= L"examples");
	boost::filesystem3::directory_iterator i (path);
}

void lambda_p_test::directory_iterator_test::run_2 ()
{
...
void lambda_p_test::directory_iterator_test::run_3 ()
{
	auto path (boost::filesystem::initial_path () /= L"examples");
