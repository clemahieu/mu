...
void lambda_p_test::routine::run_1 ()
{
	...
	boost::shared_ptr <lambda_p::core::routine> routine (new lambda_p::core::routine (errors));
	boost::shared_ptr <lambda_p::container> container (new lambda_p::container);
	routine->output->next = container;
	auto gather (boost::shared_ptr <lambda_p::core::gather> (new lambda_p::core::gather (routine->output)));
	auto scatter (boost::shared_ptr <lambda_p::core::scatter> (new lambda_p::core::scatter (2, routine->errors)));
...
void lambda_p_test::routine::run_2 ()
{
	...
	//auto scatter (boost::shared_ptr <lambda_p::core::scatter> (new lambda_p::core::scatter (4, routine->errors)));
