...
{
	::lambda_p::routine_from_stream builder;
	...
	instances [statement->association->parameters [0]] = ::boost::shared_ptr < ::lambda_p_llvm::literal_value> (new ::lambda_p_llvm::literal_value (::llvm::ConstantInt::get (::llvm::Type::getInt16Ty (llvm_context), 0xffcc)));
