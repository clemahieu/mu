...
void lambda_p_test::package_test_1::run_1 ()
{
	...
	statement1->association->references.push_back (routine->inject_declaration (boost::shared_ptr <lambda_p::binder::node> (new lambda_p::binder::data (std::wstring (name)))));
...
void lambda_p_test::package_test_1::run_2 ()
{
	...
	statement1->association->references.push_back (routine->inject_declaration (boost::shared_ptr <lambda_p::binder::node> (new lambda_p::binder::data (std::wstring (dname)))));
	lambda_p::binder::list nodes;
...
void lambda_p_test::package_test_1::run_3 ()
{
	...
	size_t declaration2 (routine->add_declaration ());
	statement1->association->declarations.push_back (declaration2);
	statement1->association->references.push_back (routine->inject_declaration (boost::shared_ptr <lambda_p::binder::node> (new lambda_p::binder::data (std::wstring (junk)))));
	statement1->association->references.push_back (routine->inject_declaration (boost::shared_ptr <lambda_p::binder::node> (new lambda_p::binder::data (std::wstring (name)))));
	lambda_p::binder::list nodes;
    nodes [declaration] = package;
    lambda_p_kernel::bind_procedure bind_procedure (routine, nodes);
