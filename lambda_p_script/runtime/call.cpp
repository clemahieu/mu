...
lambda_p_script::runtime::call::call (size_t results_a)
	: results (results_a)
{
}

void lambda_p_script::runtime::call::operator () (boost::shared_ptr <lambda_p::errors::error_target> errors_a, lambda_p_script::runtime::context & context)
{
