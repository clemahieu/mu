...
namespace lambda_p_kernel
{
	...
	{
		class number : public lambda_p::parser::state
		{
		public:
			number (lambda_p::parser::parser & parser_a, lambda_p::parser::routine & routine_a, lambda_p::parser::association_target & target_a);
