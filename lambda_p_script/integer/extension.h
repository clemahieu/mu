...
namespace lambda_p_script
{
	namespace integer
	{
		...
		boost::shared_ptr <lambda_p_script::integer::node> core_d (boost::shared_ptr <lambda_p::errors::error_target> errors_a, wchar_t const * string_a);
		boost::shared_ptr <lambda_p_script::integer::node> core (boost::shared_ptr <lambda_p::errors::error_target> errors_a, wchar_t const * string_a, size_t base_a);
	}
}
