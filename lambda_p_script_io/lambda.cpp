...
void lambda_p_script_io::lambda::operator () (boost::shared_ptr <mu::core::errors::error_target> errors_a, mu::io::analyzer::expression & expression_a)
{
	...
	if (expression_a.expression_m->values.size () > lambda_position)
	{
		...
		{
			bool good (true);
			mu::io::analyzer::analyzer analyzer (boost::bind (&lambda_p_script_io::lambda::add, this, expression_a, _1), expression_a.routine.analyzer.errors, expression_a.routine.analyzer.extensions);
...
void lambda_p_script_io::lambda::add (mu::io::analyzer::expression & expression_a, boost::shared_ptr <mu::core::cluster> cluster_a)
{
