...
lambda_p_script_io::routine::routine (boost::shared_ptr <mu::script::cluster::node> cluster_a, boost::shared_ptr <mu::core::routine> routine_a, boost::shared_ptr <mu::script::routine> result_a)
{
