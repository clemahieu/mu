...
void lambda_p_llvm_wrapper_test::module::add_package::run ()
{
	run_1 ();
}

void lambda_p_llvm_wrapper_test::module::add_package::run_1 ()
{	
	...
	auto mod1 (boost::shared_ptr <lambda_p_llvm_wrapper::module::node> (new lambda_p_llvm_wrapper::module::node (new llvm::Module (llvm::StringRef ("test"), context))));
	...
	lambda_p_llvm_wrapper::module::add_package add;
