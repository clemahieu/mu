...
void lambda_p_llvm_wrapper_test::linker::link_modules::run ()
{
	run_1 ();
}

void lambda_p_llvm_wrapper_test::linker::link_modules::run_1 ()
{
	llvm::LLVMContext context;
	std::vector <llvm::Type *> types;
	auto module (boost::shared_ptr <lambda_p_llvm_wrapper::module::node> (new lambda_p_llvm_wrapper::module::node (new llvm::Module (llvm::StringRef ("test1"), context))));	
	auto module1 (boost::shared_ptr <lambda_p_llvm_wrapper::module::node> (new lambda_p_llvm_wrapper::module::node (new llvm::Module (llvm::StringRef ("test1"), context))));	
	...
	auto module2 (boost::shared_ptr <lambda_p_llvm_wrapper::module::node> (new lambda_p_llvm_wrapper::module::node (new llvm::Module (llvm::StringRef ("test2"), context))));	
	...
	lambda_p_llvm_wrapper::linker::link_modules link_modules;
