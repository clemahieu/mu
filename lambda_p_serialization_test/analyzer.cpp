...
void lambda_p_serialization_test::analyzer::run_1 ()
{
	...
	lambda_p_serialization::analyzer::analyzer analyzer_l (boost::bind (static_cast <void (lambda_p_serialization_test::analyzer_result::*)(boost::shared_ptr <lambda_p::core::routine>)> (&lambda_p_serialization_test::analyzer_result::operator()), &result, _1), boost::bind (static_cast <void (lambda_p_serialization_test::analyzer_result::*) (boost::shared_ptr <lambda_p::errors::error>)> (&lambda_p_serialization_test::analyzer_result::operator()), &result, _1));
